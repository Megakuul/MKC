...
distributions=("bionic" "disco" "focal" "jammy" "kinetic" "lunar" "mantic")

for dist in "${distributions[@]}"; do
    dch -v "${new_pkgver}-${dist}" -D "$dist" -m "Continuous stable release, automatically generated by update_version.sh script"
done
